...
const Projects = () => {
    ...
    const [proj] = useState([
        {title: "Assassination", 
        desc: ["Assassination is a web-based social deduction game for groups to play live without the need for physical boxes, boards, cards, or other game props. All the players need is a mobile device, and a code provided by the host.", "Players are assigned roles, objectives, and a room. Kings can move players between rooms, trying to kick out assassins while making sure their guards are in thier room."], 
