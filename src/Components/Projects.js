...
const Projects = () => {
    ...
    const [proj] = useState([
        ...
        desc: ["Fridgician helps you magically turn the food in your fridge into delicious meals. Type in what you have in your fridge and Frigician will use a REST api to return delicious recipies.",], 
